  ...
  const columns = [
      ...
      cell: (p: Product) => (
        <div>
          ...
          <div className="flex items-center gap-2 mt-0.5">
            <span className="text-xs font-mono font-bold text-blue-400">SKU: {p.sku}</span>
      ...
      cell: (p: Product) => {
        ...
        return (
          <div>
            ...
            <p className="text-[10px] text-slate-400 font-mono">Min Threshold: {p.minStock}</p>
          </div>
        );
      },
    },
    {
      ...
      cell: (p: Product) => {
        const isLow = p.currentStock <= p.minStock;
        return isLow ? (
          <Badge status="LOW_STOCK">⚠️ Low Stock Alert</Badge>
        ) : (
        ...
        <div className="flex items-center gap-2" onClick={(e) => e.stopPropagation()}>
          {canManageStock && (
            <button
              ...
              className="px-2.5 py-1 text-xs font-semibold bg-blue-500/10 text-blue-400 border border-blue-500/20 rounded-lg hover:bg-blue-500/20 transition"
            >
              Stock IN/OUT
            </button>
          )}
  ...
  return (
    <div className="flex min-h-screen bg-slate-950 text-slate-100">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        <Navbar title="Product & Inventory Control" />

        <main className="p-8 space-y-6 flex-1">
          {/* Header Bar */}
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div>
              <h1 className="text-2xl font-bold text-white tracking-tight">Master Inventory</h1>
              <p className="text-slate-400 text-sm">
                SKU catalog, minimum stock guardrails, and audit log movement tracking
              </p>
            </div>
            {canManageStock && (
              <button
              ...
              >
                <Plus className="w-4 h-4" /> Add New SKU Product
              </button>
            )}
          </div>
          ...
          <Modal
            ...
            title="Add New SKU Product to Inventory"
          >
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 bg-slate-950 border border-slate-800 rounded-lg text-sm uppercase font-mono"
                  />
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 bg-slate-950 border border-slate-800 rounded-lg text-sm font-mono"
                  />
                </div>
              </div>
            ...
            >
              <form onSubmit={handleLogStockMovement} className="space-y-4">
                ...
                <div className="p-3 bg-slate-950 rounded-xl border border-slate-800 text-xs flex justify-between">
                  ...
                  <div>
                    <span className="text-slate-400 block">Current Available Stock</span>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    >
                      <ArrowDownRight className="w-4 h-4" /> Stock IN (Receive)
                    </button>
                    <button
                      type="button"
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 bg-slate-950 border border-slate-800 rounded-lg text-sm font-mono font-bold"
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="Supplier restock invoice #881"
                    className="w-full px-3 py-2 bg-slate-950 border border-slate-800 rounded-lg text-sm"
                  />
                </div>
